...
public class HoChiMinhChurchPlace extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(10.789221, 106.690396);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Tan Dinh Church"));
