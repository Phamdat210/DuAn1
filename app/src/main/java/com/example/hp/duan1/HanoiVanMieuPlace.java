...
public class HanoiVanMieuPlace extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(21.029385, 105.836174);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Temple of Literature"));
