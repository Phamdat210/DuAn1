...
public class DaNangPeninsulaPlace extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(16.115994, 108.273344);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Son Tra Peninsula"));
