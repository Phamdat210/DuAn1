...
public class HanoiHoanKiemPlace extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(21.028945, 105.852150);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Hoan Kiem Lake"));
