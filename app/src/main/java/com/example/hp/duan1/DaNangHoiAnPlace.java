...
public class DaNangHoiAnPlace extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(15.878000, 108.334740);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Hoi An"));
