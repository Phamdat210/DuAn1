...
public class HoChiMinhBitexcoPlace extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(10.771611, 106.704533);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Bitexco Tower"));
