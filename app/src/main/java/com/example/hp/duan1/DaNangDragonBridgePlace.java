...
public class DaNangDragonBridgePlace extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(16.061058, 108.227972);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Dragon Bridge"));
