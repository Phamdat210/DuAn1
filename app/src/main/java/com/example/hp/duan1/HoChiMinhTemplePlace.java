...
public class HoChiMinhTemplePlace extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(10.791965, 106.698119);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Ngoc Hoang Temple"));
